...
{
    [Header("Prefabs")]
    //[SerializeField ] GameObject laserParticleBulletPF; // hieu ung no khi va cham cua laser bullet
    ...
    public override void FixedUpdateNetwork()
    {
        ...
        //
        //int hitCount = Runner.GetPhysicsScene().OverlapSphere(checkForImpactPoint.position, 0.5f, hits, collisionLayerMask, QueryTriggerInteraction.Collide);
    }
